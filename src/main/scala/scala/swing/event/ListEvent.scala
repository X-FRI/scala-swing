...
class ListElementsAdded[A](override val source: ListView[A], val range: Range) extends ListChange(source)
...
class ListElementsRemoved[A](override val source: ListView[A], val range: Range) extends ListChange(source)
