...
package object swing:
    ...
    private[swing] def ifNull[A](o: Object, a: A): A     = if o eq null then a else o.asInstanceOf[A]
    private[swing] def toOption[A](o: Object): Option[A] = if o eq null then None else Some(o.asInstanceOf[A])
